...
- content-stream-interpreter observation with page marks for text, paths, images, XObjects, clipping, and first marked-content plus visibility evidence, including normalized path paint-state facts for line width, cap, join, miter, and dash behavior
