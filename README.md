...
- content-stream-interpreter observation with page marks for text, paths, images, XObjects, and clipping, a line-oriented layout stage with explicit heuristic limitation markers, and extractive knowledge chunks with source citations
