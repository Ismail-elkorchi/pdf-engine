import {
  projectFieldLabelFormTable,
  projectFieldValueFormTable,
} from "./forms.ts";
import { projectedTableOverlap } from "./table-selection.ts";
...
export function collectProjectedTableCandidates(
