...
- Render hashing now canonicalizes byte payloads through deterministic byte digests so large imagery-bearing pages remain hashable under the public and private proof sets.
